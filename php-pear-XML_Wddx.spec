...
- zastępuje rozszerzenie XML_Wddx (jeśli nie jest wbudowane)
- tworzy edytowalny plik wddx (z wcięciami itp.) i używa CDATA zamiast
...
i powinien być w 90% kompatybilny z wddx_deserialize(), a deserializer
będzie używał wddx_deserialize jeśli zostało wbudowane.

Aktualnie nie ma obsługi dla zbiorów rekordów w wersji PHP
deserializera.
